...
- compute environment: [Slurm](https://slurm.schedmd.com/documentation.html), Slurm without accounting, SSH to a plain machine (`direct_ssh`), [pueue](https://github.com/Nukesor/pueue) on a plain machine (`pueue_ssh`), file based (experimental)
