...
INSTRUMENT_FILE_PILE_UP_THRESHOLDS = {
    InstrumentFileStatus.INITIAL: 30,  # => indicates something is wrong with file moving
...
QUEUE_STOP_THRESHOLD_MULTIPLIER = 3  # stop: pause > N x gradient_length triggers alert
