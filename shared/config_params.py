...
PLACEHOLDER_LOCATIONS: dict[str, str] = {
    ConfigParamPlaceholders.RAW_FILE_PATH: Locations.BACKUP,
    ConfigParamPlaceholders.SETTINGS_PATH: Locations.SETTINGS,
    ConfigParamPlaceholders.OUTPUT_PATH: Locations.OUTPUT,
}
