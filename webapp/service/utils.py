...
quanting_settings_path = "n/a"  # TODO: os.environ.get(EnvVars.QUANTING_SETTINGS_PATH)
quanting_output_path = "n/a"  # TODO: os.environ.get(EnvVars.QUANTING_OUTPUT_PATH)
